...
const TopSellers = () => {
    ...
    const handleFollowClick = (i: number) => {
        setAuthors(prevAuthor => prevAuthor.map((author, ind) => ind === i ? { ...author, isFollowing: !author.isFollowing } : author))
    }
